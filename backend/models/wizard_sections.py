...
Layout (the Konva canvas editor) IS in this list as of this revision,
between Sensors and Key Personnel, so it participates in linear
Back/Next like any other section, in addition to being reachable from
the wizard progress bar and the Facility Details page. Upload and
Validate are still not in this list -- they happen before Part A
begins.
...
WIZARD_SECTIONS = [
    ...
    ("A", "4b", "Facility Layout", "layout", "factory.layout_page"),
